...
app = Flask(__name__, static_folder=os.environ['PATH_TO_SCREENS_DIR'])

loader = Img_loader()
loader.screens_path = os.environ['PATH_TO_SCREENS_DIR']
...
def caricatures():
    ...
    if 'control_button' in query_params:
        if query_params['control_button'] == 'Next':
            loader.next_image()
            img_to_display = os.path.join('screens', loader.curr_year, loader.curr_publication, loader.curr_screen)
